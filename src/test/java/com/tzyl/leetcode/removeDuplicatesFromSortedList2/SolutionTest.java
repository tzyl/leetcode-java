...
public class SolutionTest {
    ...
    public void testBasicCase() {
        ListNode head = generateLinkedList(new int[]{1, 2, 3, 3, 4, 4, 5});
        ListNode expected = generateLinkedList(new int[]{1, 2, 5});
    ...
    public void testDuplicatesAtBeginning() {
        ListNode head = generateLinkedList(new int[]{1, 1, 1, 2, 3});
        ListNode expected = generateLinkedList(new int[]{2, 3});
        ListNode newHead = solver.deleteDuplicates(head);
        compareLinkedList(newHead, expected);
    }
